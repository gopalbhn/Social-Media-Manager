...
export default function Signup() {
 ...
 async  function handleSubmit(){
  try{
    ...
    const res = await  axios.post('http://localhost:3000/routes/signin',{
      name:name,
      email:email,
      password:password
    });
  ...
  return (
    <div class="h-100 w-80 mt-10 p-2 px-5  mx-auto rounded-xl shadow-3xl  dark:shadow-[#2f27ce]  shadow-[#bfbdeb]">
        <div class="text-xl text-center my-2">SignUp</div>
        <div>
        <label htmlFor="fullName" class="text-md">
          Full Name
        </label>
        <input
          type="text"
      ...
      <div class="w-full flex items-center">
        <button class="mx-auto mt-2  h-10 w-[50%] bg-[#2f27ce] hover:bg-[#433bff] rounded-full text-md text-white" onClick={handleSubmit}>Sign Up</button>
        </div>
      <div class="h-px  w-full bg-[#858282] mt-5 relative flex justify-center">
        ...
        <div class='h-8 w-[90%] mx-auto mt-5 pl-5 rounded-xl border-[1px] border-black dark:border-white flex items-center gap-4 hover:cursor-pointer hover:border-[2px]'>
            ...
            <button onClick={()=>{
              window.location.href = 'http://localhost:3000/routes/auth/google'
